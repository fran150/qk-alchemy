...
define([
    'knockout',
    'quark',
    'text!./mega-dropdown.component.html',
    '../../../lib/utils',
    '../navbar.component',
    'loadCss!../../../css/mega-dropdown'
], function(ko, $$, template, utils, Navbar) {

    function LayoutNavbarMegaDropdownComponent(params, $scope) {
        var self = this;
    ...
    return $$.component(LayoutNavbarMegaDropdownComponent, template);
});
